...
cropped_data_path = os.path.join(root,'data/cropped_data_bkp')
cropped_images_path = os.path.join(root,'data/cropped_data_bkp/images')
cropped_masks_path = os.path.join(root,'data/cropped_data_bkp/masks')
cropped_tot_bkg_data_path = os.path.join(root,'data/cropped_data_bkp', 'tot_bkg')
...
cropped_tot_bkg_images_path = os.path.join(root,'data/cropped_data_bkp', 'tot_bkg/images')
...
cropped_test_1_data_path = os.path.join(root,'data/test_1/cropped_data_bkp')
cropped_test_1_images_path = os.path.join(root,'data/test_1/cropped_data_bkp/images')
cropped_test_1_masks_path = os.path.join(root,'data/test_1/cropped_data_bkp/masks')
...
cropped_april_data_path = os.path.join(root,'data/april/cropped_data_bkp')
cropped_april_images_path = os.path.join(root,'data/april/cropped_data_bkp/images')
cropped_april_masks_path = os.path.join(root,'data/april/cropped_data_bkp/masks')
...
cropped_may_data_path = os.path.join(root,'data/may/cropped_data_bkp')
cropped_may_images_path = os.path.join(root,'data/may/cropped_data_bkp/images')
cropped_may_masks_path = os.path.join(root,'data/may/cropped_data_bkp/masks')
...
cropped_test_original_data_path = os.path.join(root,'data/original_test/cropped_data_bkp')
cropped_test_original_images_path = os.path.join(root,'data/original_test/cropped_data_bkp/images')
cropped_test_original_masks_path = os.path.join(root,'data/original_test/cropped_data_bkp/masks')
...
cropped_train_renamed_masks_path = os.path.join(root,'data/train/cropped_data_bkp/renamed_masks')
cropped_train_threshold_results = os.path.join(root,'data/train/cropped_data_bkp/threshold_masks')

cropped_tot_bkg_renamed_masks_path = os.path.join(root, 'data/cropped_data_bkp/tot_bkg/renamed_masks')
cropped_renamed_masks_path = os.path.join(root, 'data/cropped_data_bkp/renamed_masks')
...
# Cropped train&val
cropped_train_path = os.path.join(root, 'data/train/cropped_data_bkp')
cropped_train_masks_path = os.path.join(root,'data/train/cropped_data_bkp/masks')
cropped_train_images_path = os.path.join(root, 'data/train/cropped_data_bkp/images')

cropped_val_path = os.path.join(root, 'data/val/cropped_data_bkp')
cropped_val_images_path = os.path.join(root, 'data/val/cropped_data_bkp/images')
cropped_val_masks_path = os.path.join(root, 'data/val/cropped_data_bkp/masks')
cropped_val_tot_bkg_images_path = os.path.join(root, 'data/val/cropped_data_bkp/tot_bkg/images')
cropped_val_tot_bkg_masks_path = os.path.join(root, 'data/val/cropped_data_bkp/tot_bkg/masks')
...
# Cropped test1
cropped_test_data_path = os.path.join(root, 'data/test/cropped_data_bkp')
cropped_test_renamed_masks_path = os.path.join(root, 'data/test/cropped_data_bkp/renamed_masks')

cropped_test_images_path = os.path.join(root, 'data/test/cropped_data_bkp/images')
cropped_test_masks_path = os.path.join(root, 'data/test/cropped_data_bkp/masks')
