...
# Default values
entity="robmorelli"
project_name="segformer_hyp_opt_dv"
sweep_cfg="sweep"
exps_num=20
ngpus=1
ncpus=12
...
#./artificial_intelligence/repos/fuselage_defects_segmentation/batch_scripts/000_wrapper_run_batch_hyp.sh --entity robmorelli --project_name segformer_hyp_opt_dv  --sweep_cfg sweep --exps_num 20  --ngpus 3 --ncpus 36
