...
def main(args):
    ...
    sweep_config['parameters']['devices'] = {'value': int(args.ngpus)}
    ...
    if args.sweep_id is not None:
        ...
        command = f"wandb agent robmorelli/segformer_hyp_opt_dv/{args.sweep_id}"
...
if __name__ == '__main__':
    ...
    parser.add_argument("--project_name", default='segformer_hyp_opt_test',
